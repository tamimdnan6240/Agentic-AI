# -*- coding: utf-8 -*-
"""BM25+Knowledge-graph-2017-2019-No-maintenance.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vmZYLThz2Gxsqh-S-vhUKj-uUsMm10Wf
"""
...
DATASET_DIR = "/content/drive/MyDrive/Agentic-AI-Asset-management/Tamim/codes/Data/No-maintenance-data"

# Your pinned CSV file (this specific file will be used as the dataset)
PINNED_FILE_PATH = "/content/drive/MyDrive/Agentic-AI-Asset-management/Tamim/codes/Data/No-maintenance-data/2017-2019 (no main).csv"
...
If hits exists:
  - Do NOT rerun the state unless planner explicitly requests rerun.
...
PINNED DATASET RULE
========================
- For this run, the registry is pinned by environment PINNED_FILE_PATH.
- Always use validate_registry(WORK_DIR) and the returned latest_path.
- Do NOT rebuild registry from DATASET_DIR unless planner explicitly disables pinning.
...
You guide the coder_agent (Agent-3) for the following tasks:
 ...
 - Select IRI_mean_y as the target from target_candidates
 ...
 - Select best predictive model for XAI analysis
 - Must save all model ouputs in a document
...
- Ensure the coder_agent strictly followed the data_scientist_agent’s instructions.
...
- Confirm coder used mm.validate_registry(WORK_DIR) before reading data.
...
- Check if the models are state-of-the-art models. Otherwise recommend the data scientist to choose better model predicitive models for the dataset.
...
IMPORTANT
- Reviewer MUST NOT choose the final target.
...
simple_kickoff = """
Develop the pavement condition predicition pipeline
